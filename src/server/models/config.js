...
module.exports = function(crowi) {
  ...
  function getDefaultCrowiConfigs() {
    ...
    return {
      ...
      'security:passport-generic-oidc:isEnabled' : false,
  ...
  configSchema.statics.isEnabledPassportGenericOidc = function(config) {
    const key = 'security:passport-generic-oidc:isEnabled';
    return getValueForCrowiNS(config, key);
  };
