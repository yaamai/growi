...
module.exports = function(crowi, app) {
  ...
  app.post('/_api/admin/security/passport-generic-oidc', loginRequired(crowi, app) , middleware.adminRequired() , csrf, form.admin.securityPassportGenericOidc, admin.api.securityPassportGenericOidcSetting);
  ...
  app.get('/passport/generic-oidc'                , loginPassport.loginWithGenericOidc);
  ...
  app.get('/passport/generic-oidc/callback'       , loginPassport.loginPassportGenericOidcCallback);
